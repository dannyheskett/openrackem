...
# Apple rejects a listing that names another platform or store, and the name of
# the commercial rack-sorting game this plays like is its rights holder's
# trademark (the Trademark note in android/play-assets/LISTING.md). Both rules
# are recorded in the listing files themselves; this makes them fail a build
# rather than a review.
BANNED_EVERYWHERE = ("rack-o", "racko")
